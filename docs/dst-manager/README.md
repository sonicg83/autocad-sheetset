...
DST Manager 面向单人单机真实工程，提供既有 DST/DWG 的检查、编辑和安全发布能力。当前版本为 `v0.2.1`。
...
当前没有独立 PRD 或 ADR。功能规范：

- [v0.21 图纸集编辑需求调整规范（SPEC-DM-001，草案）](specs/SPEC-DM-001-v021-sheetset-editing-adjustment.md)
